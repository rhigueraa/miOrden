...
/**
 ...
 @warning Note: You do NOT have to use 'SCTableViewController' in order to be able to use SCTableViewModel,
 it is just provided as an additional convenience to you.
 
 @warning Note: Some Sensible TableView objects use 'SCTableViewController' to display their own detail views.
 */
...
/** The associated table view model. This model is configured and ready to be populated with sections and cells. */
...
/** Method gets called when the Cancel button is tapped in 'Editing Mode'. */
